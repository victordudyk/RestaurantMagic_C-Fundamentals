...
namespace ConsoleApp1
{
    public class LessonFour
    {
        ...
        {
            Customer customer1 = new Customer("John", 20, DateTime.Now, true);
            Customer customer2 = new Customer("Richard", 20, DateTime.Now, true);
            ...
            Order order1 = new Order(purchase1);
            Order order2 = new Order(purchase2);
            Order order3 = new Order(purchase3);
